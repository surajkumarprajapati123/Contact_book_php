...
if (!empty($contactId) && is_numeric($contactId)) {
    ...
    $sql = "SELECT * FROM `contacts2` WHERE `id`={$contact_Id} AND `owner_id`={$userId}";
...
<div class="container" id="profile">
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <img src="<?php echo !empty($contactResult['photo']) ? SITEURL . "uploads/photo/" . $contactResult['photo'] : "https://via.placeholder.com/50.png/09f/666"; ?>" width="150" class="img-thumbnail" />
            </div>
            <div class="col-sm-6 col-md-8">
                ...
                <!-- <button class="btn btn-primary text-center" onclick="return <?php echo SITEURL?>"><span class="bi-return"></span>Back TO Home Page</button> -->
                <!-- Split button -->
            </div>
        </div>
